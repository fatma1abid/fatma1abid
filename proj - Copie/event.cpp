...
void event::on_pushButton_ajouter_E_clicked()
{
    evenement e;
...
void event::on_pushButton_supprimer_E_clicked()
{
...
void event::on_tableView_clicked(const QModelIndex &index)
{
...
void event::on_pushButton_modifier_E_clicked()
{
    int code = ui->lineEdit_code->text().toInt();
    QString nom= ui->lineEdit_nom->text();
    QString dates= ui->lineEdit_date->text();
...
void event::on_pushButton_rafraichir_E_clicked()
{
    ui->lineEdit_code->setText("");
    ui->lineEdit_nom->setText("");
    ui->lineEdit_date->setText("");
...
void event::on_pushButton_quitter_clicked()
{
    close();
}


void event::on_pushButton_rafraichir_clicked()
{
    ui->tableView->setModel(tmp.afficher());
...
void event::on_pushButton_2_quitter_clicked()
{
    close();
}


void event::on_pushButton_tri_codee_clicked()
{
    ui->tableView->setModel(tmp.trier_code());
}


void event::on_pushButton_tri_nom_clicked()
{
    ui->tableView->setModel(tmp.trier_nom());
}


void event::on_pushButton_tri_prix_clicked()
{
    ui->tableView->setModel(tmp.trier_prix());
}


void event::on_pushButton_chercher_type_clicked()
{
...
void event::on_pushButton_chercher_ville_clicked()
{
...
void event::on_pushButton_pdf_clicked()
{
...
QVector<double> event::Statistique()
{
    QSqlQuery q;
...
void event::makePlot()
{
    ...
    bars1->setData(x3, event::Statistique());
...
void event::on_pushButton_statistique_clicked()
{
    event::makePlot();
}
